      ...
      <v-flex xs12 md8 class="mt-xs">
        <v-list two-line subheader>
          ...
          <div class="text-xs-right">
            <v-btn :to="'/edit_user'" dark color="primary" class="mt-2"
              >Edit info</v-btn
            >
          </div>
        </v-list>
    ...
    setData(user) {
      ...
      this.items = [
        ...
        { icon: "person", title: "Username", subtitle: this.user.username },
        {
          icon: "face",
          title: "Full Name",
          subtitle: this.user.fullName ? this.user.fullName : "No information"
        },
        {
          icon: "calendar_today",
          title: "Date of Birth",
          subtitle: this.user.dateOfBirth
        ...
        },
        {
          icon: "location_on",
          title: "Location",
          subtitle: this.user.location ? this.user.location : "No information"
        }
      ];
    }
  },
